...
<div id="tooplate_main"><span class="main_border main_border_t"></span><span class="main_border main_border_b"></span>
    	<div class="col col_1">
            <h1 align="center">Дякуємо за Ваше замовлення, </h1>
            <h1 align="center"> №(${numberOrder})</h1>
            <p align="center">  <img src="/resources/jpg/ok.png" alt="Замовлення прийнято"> </p>
          
		</div>
        <div class="center-block">

            <p align="center">Шановний ${userName}, ваше замовлення прийнято, найближчим часом з Вами зв'яжиться наш менеджер  </p>
            <p align="center"> і дасьть відповіді на всі ваші питання. Дякує, що обрали саме нас!  </p>
    ...
    <p align="center"><a href="/" class="button">На головну</a></p>
